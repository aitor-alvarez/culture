function create_slider(responses){
    var sliders=new Array();
    $.each(responses, function (index, item) {
        class1 = 'slider-experts-'+item[0];
        class2 = 'slider-results-'+item[2];
    ...
    sliders.push([s1, item[1], s2, item[3]]);

    });

    $.each(sliders, function (index, item) {

        sliders[item[2].setAttribute('disabled', true)];
